...
const PurchaseDecisionPage = lazy(() => import('@/pages/purchase-decision'))
            ...
            <Suspense fallback={<LoadingFallback />}>
              <Routes>
                ...
                >
                  ...
                  <Route path="/purchase-decision" element={<ModuleRoute module="purchase_decision"><PurchaseDecisionPage /></ModuleRoute>} />
