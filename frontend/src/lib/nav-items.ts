...
export const navItems: NavItem[] = [
  ...
  { type: 'link', key: 'insights', path: '/insights', icon: LineChart, module: 'insights' },
  { type: 'link', key: 'assets', path: '/assets', icon: Landmark, module: 'assets' },
  { type: 'separator', labelKey: 'nav.groupTools' },
  { type: 'link', key: 'purchaseDecision', path: '/purchase-decision', icon: ShoppingCart, module: 'purchase_decision' },
